...
const data = [
  ...
  { id: 2, title: "pam", subtitle: "black", address: "festac" },
];
  ...
  return (
    <div className="Listing">
      <div className="listing-section">
        ...
        <span className="recently-added">
          Recently Added Listings{" "}
          <span className="recently-addedd-view-all">View All</span>
        </span>
        <img
        ...
        <br />
        <img
          className="rectangle listing-img"
        ...
        <span className="bed-room">
          2 bedroom apartment for sharing{" "}
          <span className="flat-quest">Send Flatquest</span>
        </span>
        <img
          className="vertical"
